  ...
  public static void main(String[] arg) {
    ...
    for (int i = 0; i < arg.length; i++) {
      if (arg[i].compareTo("-help") == 0) {
        System.err.println("Supply Chain Optimization Project");
    ...
    try {
      ...
      if (!feasible){
        ...
        if (t > (max_time + 1) * 1000) {
          e = 2;
          System.err.println("Time limit exeeced !!!");
        }
      }
      ...
      if (verbose) {
        ...
        if (e == 1)
          System.err.println("There is an error in the solution: " + tsp.getSolution().getError());
      }
      ...
      System.err.println("An error has been met when reading the input file: " + e.getMessage());
      System.exit(1);
    } catch (Exception e) {
