...
public class TSPSolver {
	...
	public void solve() throws Exception {
		 ...
		 GRASP Grasp=new GRASP(m_instance,1,m_time);
		 	//m_solution=Grasp.solve(); // it uses random insertion instead
		 //m_solution=Grasp.solveGreedy();
		 m_solution=Grasp.basicGrasp();
